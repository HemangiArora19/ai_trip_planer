export const SelectTravelsList = [
  {
    id: 1,
    title: 'Just Me',
    desc: 'A solo traveler seeking exploration',
    icon: '🌍',
    people: '1',
  },
  {
    id: 2,
    title: 'A Couple',
    desc: 'Two travelers enjoying tandem journeys',
    icon: '💑',
    people: '2 People',
  },
  {
...
export const SelectBudgetOptions = [
  ...
  },
  {
    id: 2,
    title: 'Moderate',
    desc: 'Balanced spending for value',
    icon: '🎯',
  },
  {
    id: 3,
...
me Hotels options list with HotelName, Hotel address, Price, hotel 
